...
;--------------------------------------------------------
;	.file	"E:\360安全云盘-同步版\00矽杰单片机DEMO\XC8P9520_DEMO\XC8P9520_DEMO_C\4_XC8P9520_WDT\XC8P9520-WDT.C"
	list	p=XC8P9520
	radix dec
...
; global definitions
;--------------------------------------------------------
UD_XC8P9520_WDT_0	udata
_reg_sleep_cnt	res	1

;--------------------------------------------------------
; absolute symbol definitions
;--------------------------------------------------------
UD_abs_XC8P9520_WDT_10	udata_ovr	0x0010
_A_BUFF
	res	1
UD_abs_XC8P9520_WDT_11	udata_ovr	0x0011
_R3_BUFF
	res	1
;--------------------------------------------------------
; compiler-defined variables
;--------------------------------------------------------
UDL_XC8P9520_WDT_0	udata
r0x1003	res	1
r0x1004	res	1
r0x1001	res	1
;--------------------------------------------------------
...
;has an exit
;; Starting pCode block
S_XC8P9520_WDT__file_WDTWake_slep	code
...
;has an exit
;; Starting pCode block
S_XC8P9520_WDT__file_WDTTime	code
...
;has an exit
;; Starting pCode block
S_XC8P9520_WDT__file_init	code
...
;has an exit
;; Starting pCode block
S_XC8P9520_WDT__file_clrRam	code
