 ...
 * Description:
 * ------------
 *   Image Sensor tuning parameter, mainly locate the ISP parameter and used for raw sensor, for
 *	yuv sensor, it ony used for the ISP default setting and share a common setting.
 *
 * Author:
 * -------
 *   QH Geng (mtk70548)
...
#include "drv_features.h"
	...
	const nvram_camera_para_struct GC0308_CAMERA_PARA_DEFAULT_VALUE={0};
#else
#include "camera_para.h"
#include "camera_sensor_para_GC0308.h"
#include "camera_af_para.h"

#define GC0308_CAMERA_SENSOR_CCT_DEFAULT_VALUE {{ 0xFFFFFFFF, 0x08 } ,{ 0x0209, 0x0008 } ,{ 0x0207, 0x0008 } ,{ 0x020D, 0x0008 } ,{ 0x020B, 0x0008 }}


const nvram_camera_para_struct GC0308_CAMERA_PARA_DEFAULT_VALUE=
{
	/* STRUCT: ISP */
	{
		/* ARRAY: ISP.reg[144+8] */
    ...
    //ISPTUNING
	{
	 ...
	 {
		GC0308_CAMERA_SENSOR_REG_DEFAULT_VALUE,
	 	GC0308_CAMERA_SENSOR_CCT_DEFAULT_VALUE,
	 }
...
const nvram_camera_para_struct GC0308_CAMERA_PARA_DEFAULT_VALUE=
{
	/* STRUCT: SENSOR */
	{
		/* ARRAY: SENSOR.reg[35] */
		{
			/* Use SENSOR.reg[0] as the switch whether write the following parameter to sensor */
			/* Both SENSOR.reg[0].addr and data are 0 means not writing parameter  */
			/* Both SENSOR.reg[0].addr and data are non-zero means writing parameter  */
			 {0x0, 0x0} 
			,{0x30180080, 0x30190070} ,{0x3350002e, 0x33510025} ,{0x33520008, 0x3353001e} ,{0x33560030, 0x33570025}
			,{0x33580000, 0x3359001e} ,{0x335c002e, 0x335d0025} ,{0x335e0008, 0x335f001b} ,{0x30690080, 0x33730030}
			,{0x33760004, 0x33800026} ,{0x3381005a, 0x33820008} ,{0x3383002d, 0x338400b8} ,{0x338500e4, 0x338600af}
			,{0x338700ab, 0x33880004} ,{0x33400006, 0x33410014} ,{0x3342002b, 0x33430042} ,{0x33440055, 0x33450065}
			,{0x33460070, 0x3347007c} ,{0x33480086, 0x33490096} ,{0x334a00a3, 0x334b00af} ,{0x334c00c4, 0x334d00d7}
			,{0x334e00e8, 0x3327000c} ,{0x33280010, 0x33290013} ,{0x332a0058, 0x332b005f} ,{0x332c00be, 0x332d009b}
			,{0x332e003a, 0x332f0036} ,{0x3330004d, 0x33310044} ,{0xFFFFFFFF, 0xFFFFFFFF} ,{0xFFFFFFFF, 0xFFFFFFFF}
			,{0xFFFFFFFF, 0xFFFFFFFF} ,{0xFFFFFFFF, 0xFFFFFFFF} ,{0xFFFFFFFF, 0xFFFFFFFF} ,{0xFFFFFFFF, 0xFFFFFFFF}
			,{0xFFFFFFFF, 0xFFFFFFFF} ,{0xFFFFFFFF, ISP_DRIVING_8MA}
			//------------------------Engineer mode---------------------------------
		},
		//------------------------CCT mode---------------------------------
		{
