...
;--------------------------------------------------------
;	.file	"D:\DOC\DOC\云世\项目\电子烟\XC8P9520_DEMO\XC8P9520_DEMO\XC8P9520_DEMO_C\1_XC8P9520_PWM\XC8P9520-PWM.C"
	list	p=XC8P9520
	radix dec
...
;--------------------------------------------------------
UD_abs_XC8P9520_PWM_10	udata_ovr	0x0010
_A_BUFF
	res	1
UD_abs_XC8P9520_PWM_11	udata_ovr	0x0011
_R3_BUFF
	res	1
;--------------------------------------------------------
; compiler-defined variables
;--------------------------------------------------------
UDL_XC8P9520_PWM_0	udata
r0x1000	res	1
r0x1001	res	1
;--------------------------------------------------------
; initialized data
...
;has an exit
;; Starting pCode block
S_XC8P9520_PWM__file_project_init	code
...
;has an exit
;; Starting pCode block
S_XC8P9520_PWM__file_init	code
...
;has an exit
;; Starting pCode block
S_XC8P9520_PWM__file_clrRam	code
