...
;****************************************
flag_mode			==	0x10  
;bit_lvdSure			==	flag_mode.0		;LVD标志位
bit_keyPress		==	flag_mode.1 	;按键按下标志位
bit_keyPress_deal	==	flag_mode.2		;按键执行标志位
bit_modeOpen		==	flag_mode.3		;开机标志位
bit_end1ms			==	flag_mode.4
;****************************************
; 所有寄存器定义，以reg开头
;**************************************** 
reg_keyCont			==	0x22			;按键检测滤波
reg_timeSleep		==	0x23			;睡眠确认滤波
